...
####Use Case Name: Add Comment to Immunization
...
**Purpose:**                   The main intent of this use case is to add comment/note to the immunization.

**Pre Condition:**             Doctor/ Physician/ Clinician must be identified and authenticated.  

**Post Condition:**            IThe comment/note added successfully.      
...
1.	Physician will select the immunization from the list and will add comment/note to specific problem.
2.	Physician will save the comment.
3.	System will associate the comment to particular immunization.
