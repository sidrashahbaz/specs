#####Use Case ID: UC-PCS11
####Use Case Name: Remove Immunization
...
**Purpose:**                   The main intent of this use case is to remove immunization from the list.

**Pre Condition:**             Doctor/ Physician/ Clinician must be identified and authenticated.  

**Post Condition:**            Immunization removed successfully from the list.    

**Frequency of Occurrence:**   Medium

**Priority:**                  High
__________________________________________________________
**Main Success Scenario: (Remove Immunization)**

1.	Physician requests to remove an immunization.
2.	System displays the list of patient specific immunization.
3.	Physician selects an appropriate immunization.
4.	System removes the immunization from the list.
