#####Use Case ID: UC-PCS59
####Use Case Name: Update Medication
...
**Purpose:**                   The main intent of this use case is to update medication in the list.

**Pre Condition:**             Doctor/ Physician/ Clinician must be identified and authenticated.  

**Post Condition:**            NMedication updated successfully without any conflicts.  

**Frequency of Occurrence:**   High

**Priority:**                  High
__________________________________________________________
**Main Success Scenario: (Update Medication)**

1.	Physician selects the update medication option.
2.	System shows the list of the current medications of particular patient.
3.	Physician will select the medication from the list.
4.	System will display the history of changes made to a specific medication, including clinician, date, and time.
...
7.	Physician will save the updated medication.
8.	System will perform following actions:
    ...
    * It will record the date and time of the updating of medication.
