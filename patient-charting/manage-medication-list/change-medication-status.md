#####Use Case ID: UC-PCS60
####Use Case Name: Change Medication Status
...
**Purpose:**                   The main intent of this use case is to check and update the status of medication.

**Pre Condition:**             Doctor/ Physician/ Clinician must be identified and authenticated.  

**Post Condition:**            Medication status changed successfully. 

**Frequency of Occurrence:**   High

**Priority:**                  High
__________________________________________________________
**Main Success Scenario: (Change Medication Status)**

1.	Physician will select the medication from the list and will request for the status of medication.
2.	System will respond with the current status of medication.
3.	Physician will check the status and will change it i.e. activate, deactivate, renew, discontinue or suspended. 
4.	Physician will save the changes made in medication list.
5.	System will set the status of problem to active, de-active, renew, discontinue or suspended.
...
![image](https://f.cloud.github.com/assets/4283040/1379481/19df9918-3aef-11e3-989a-08d96171c698.png)
